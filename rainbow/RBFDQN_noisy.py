...
"""
NOTE: Using noisy nets removes the need for epsilon-greedy
"""
# TODO: Normalization?
# TODO: resolve train() vs eval() issue -- dropout is activate on train()
...
class Net(nn.Module):
    def __init__(self, params, env, state_size, action_size, device):
        ...
        ## NoisyLinear layers aleady initialize themselves (see reset_parameters() and reset_noise())
...
if __name__ == '__main__':
    ...
    for episode in range(params['max_episode']):
        ...
        while not done:
            ## NOTE: NoisyNets replaces the epsilon greedy
